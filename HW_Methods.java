...
public class HW_Methods
{
       public static void main(String[] args)
    {
      ...
      /**
     * Displays the boards 1 and 2 in a String sequence
     * 
     ...
     * 
     * @param The string of characters inputed by
    ...
    public static void segment2(String coin)
    {
       ...
       String ground = "||";
       String groundWithQuestionCoin = "||      |?|" + coin;
       System.out.println(ground + '\n' + groundWithQuestionCoin + 
               '\n' + ground + '\n' + ground + '\n' + groundWithQuestionCoin
               + '\n' + ground + '\n' + '\n');
    ...
    public static void segment3(String mario)
    {
        ...
        String steps = "||";
        String stepsMario = "||" + mario;
        String flag = "||                ^";
        String flagpole = "|------------------"; 
        System.out.println(steps + '\n' +  steps + steps + '\n' +  steps
                + steps + steps +  '\n' + steps + steps + steps + steps 
                + '\n' + steps + steps + steps + steps + steps + '\n'
                + steps + steps + steps + steps + steps + stepsMario + 
                '\n' + flag + '\n' + flagpole);
